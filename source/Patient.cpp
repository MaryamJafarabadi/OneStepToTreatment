...
bool Patient::checkData(std::string email_, std::string phone_number_)
{
    if(email == email_ && phone_number == phone_number_)
        return true;
    return false;
}
...
void Patient::add_request(Request* r)
{
...
bool Patient::checkReqValid(Request* req)
{
